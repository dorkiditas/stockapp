...
CATALYSTS = [
    ...
    ("2026-08-26", "NVDA FQ2'27 财报(盘后,公司已确认)", "全 AI 链 binary:AVGO/SPCX/QCOM/CBRS 同向",
     "TipRanks/公司确认;8/16 核实。★在案:NVDA 前 AVGO 减100/CBRS条件减60 须了结"),
    ("2026-08-28", "美国非农基准修正(preliminary benchmark revision)", "宏观/9月定价",
     "Citi 宏观 8/7 Figure 28 日程表"),
    ("2026-08-29", "Jackson Hole——Fed 主席 Warsh 主旨演讲", "全书(利率动量)",
     "Citi 宏观 8/7 Figure 28;花旗框架:要命的是收益率动量不是水平"),
    ("2026-09-11", "美国 8 月 CPI", "9/16 FOMC 定价", "Citi 宏观 8/7 Figure 28"),
    ("2026-09-23", "Everpure(P)分析师日——或官宣第二家超大厂客户", "SIMO(候选)",
     "MS Chipflation 8/10 p57;MS 认为管理层不会无进展开会"),
    ("2026-09-02", "AVGO FQ3 财报(盘后)", "AVGO",
     "AVGO 档案已写死必问清单五条"),
    ("2026-09-16", "FOMC 决议(14:00 ET)+ 记者会;9/11 CPI 后市场锁定降25bp", "全书(长久期)",
     "CNBC 9/10 确认日期;档案已把 9 月中旬标为全年最需要低杠杆的窗口——BoJ 同周,"
     "花旗机制:BoJ 过去5次加息市场都在会前一周才定价到80%"),
    ("2026-09-24", "SPCX 第四批解禁约 3.28 亿股", "SPCX",
     "Yahoo Finance/CNBC 解禁时间表 9/12 核;8/6·8/20·9/9 三批均被吸收着涨过去"),
    ("2026-11-01", "CBRS Q3 财报(11 月,日期待公司确认)", "CBRS",
     "CBRS 档案三条证伪线在这一份一次揭晓"),
    ("2026-11-01", "SIEGY FY26 Q4(11 月,日期待确认)", "SIEGY",
     "SIEGY 复议的一级源验证点"),
    ("2026-11-05", "QCOM FQ4(11 月上旬,日期待公司确认)——QCT 毛利率 48% 裁决线", "QCOM",
     "档案 8/13/9/12 层;9/8 亚马逊合作后首份财报"),
    ("2026-12-01", "CRDO FQ2'27(12 月初,日期待确认)——指引隐含增速 <+80% = 减速实锤", "CRDO",
     "CRDO 档案 9/12 重开层证伪线①"),
