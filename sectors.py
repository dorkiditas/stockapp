...
SECTORS = {
    ...
    "光互连/光模块": {
        "verdict": "🟢/🟡 结构性上行(Citi:2028→$920亿/1.6T+215%);基本面真但A股筹码极挤——卡位强、别盲追高",
        "tickers": {
            "COHR": "Coherent·相对值PS11(美)", "LITE": "Lumentum·PS26(美)",
            "CIEN": "Ciena·隐含+40%没人挤(美)", "AAOI": "应用光电·弹性大(美)",
            "FN": "Fabrinet·代工龙头(美)", "300308": "中际旭创·全球最挤但需求真(A)",
            "300502": "新易盛·Citi上调¥701、3.2T/NPO受益(A)", "300394": "天孚通信·Citi上调¥419、CPO受益(A)",
            "002384": "东山精密·Citi上调¥350、光芯片+模块份额(A)", "688498": "源杰科技·PS585(A)",
            "002281": "光迅科技(A)", "300570": "太辰光·Citi下调至Sell(Corning脱钩+估值)(A)",
            "688048": "长光华芯·激光芯片(A)"},
    },
    "网络/交换": {
    ...
    "存储/HBM": {
        "verdict": "🟢 超级周期确认 —— 美光5月季GM 84.6%、NAND紧到CY27、苹果要涨价;海力士/三星forward仅6倍",
        "tickers": {
