...
# ── 周期硬指标(事实 · 手动更新)──
FACTS_ASOF = "2026-06-30"
FACTS_SRC = "高盛存储跟踪 / TrendForce现货合约板 / 华安·存储深度 / 美光长协纪要"
...
FUNDAMENTALS = [
    ...
    ("HBM4 格局", "海力士唯一量产;份额预期 海力士40/三星35/美光25", "海力士质量最高"),
    ("HBM vs DRAM", "DRAM价已反超HBM(倒挂)", "原厂更愿扩DRAM→常规DRAM更紧"),
]
